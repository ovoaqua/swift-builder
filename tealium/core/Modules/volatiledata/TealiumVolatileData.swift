...
public class TealiumVolatileData {
    ...
    public init(config: TealiumConfig) {
        self.sessionData = SessionData(config: config)
    }
    
    public var dictionary: [String: Any] {
        self.sessionData.dictionary
    }
    ...
    public func add(data: [String: Any]) {
        TealiumQueues.backgroundConcurrentQueue.write {
            self.sessionData.add(data: data)
        }
    }
    
    public func add(value: Any, forKey: String) {
        TealiumQueues.backgroundConcurrentQueue.write {
            self.sessionData.add(value: value, forKey: forKey)
        }
    }
    ...
    public func getData() -> [String: Any] {
        return TealiumQueues.backgroundConcurrentQueue.read {
            return self.sessionData.dictionary
        }
    }
...
//    }
    ...
    public func deleteData(forKeys keys: [String]) {
        TealiumQueues.backgroundConcurrentQueue.write {
            self.sessionData.deleteData(forKeys: keys)
        }
    }
    ...
    public func deleteAllData() {
        TealiumQueues.backgroundConcurrentQueue.write {
            self.sessionData.deleteAllData()
        }
    }
