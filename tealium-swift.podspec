...
Pod::Spec.new do |s|
  ...
  s.subspec "TealiumFull" do |full|
    ...
    full.osx.exclude_files = "tealium/tagmanagement/*","tealium/autotracking/*","tealium/remotecommands/*","tealium/attribution/*","tealium/crash/*","tealium/scripts/*","tealium/location/*","tealium/coolmodule/*" ,"tealium/newmodule/*" ,"tealium/newmodule/*" 
  ...
  s.subspec "TealiumCoolModule" do |coolmodule|
    coolmodule.tvos.deployment_target = "9.0"
